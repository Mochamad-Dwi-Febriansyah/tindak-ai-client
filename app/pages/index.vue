...
<template>
    <NuxtLayout>
               <div class="" style="background-image: url('/images/Slide 16_92.png');background-size: cover;background-repeat: no-repeat; background-position: center;">
        <div class="px-4 my-15 sm:px-6 lg:px-8 " >
            <div class="flex flex-col justify-center items-center gap-6">
                <div class="text-center mb-3">
                    <h1 class="text-indigo-700 md:text-4xl text-3xl font-bold">Tindak.AI</h1>
                    <span class="font-normal md:text-xl text-md">Platform pengaduan infrastruktur, tata kelola, dll.</span>
                </div>
                ...
                <!-- form -->
                <form  class="max-w-2xl w-full border border-gray-300 rounded-lg focus:shadow-md p-6 bg-white transition-shadow hover:shadow-md focus-within:shadow-md">
                    <div class="space-y-12">
                        <div class="border-b border-gray-900/10 pb-12">
                            ...
                            <div class="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="col-span-full text-center">
                                  ...
                                  <div class="col-span-full">
                                    ...
                                    <div
                                      ...
                                      <div class="col-span-full">
                                    <label for="first-name" class="block text-sm/6 font-medium text-gray-900">Lokasi</label>
                                    <div class="mt-2">
                                    ...
                                    <label for="first-name" class="block text-sm/6 font-medium text-gray-900">Latitude</label>
                                    <div class="mt-2">
                                        <input type="text" name="first-name" id="first-name" autocomplete="given-name"
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                    </div>
                                    ...
                                    <div class="mt-2">
                                      ...
                                      <div class="col-span-full">
                                    <label for="first-name" class="block text-sm/6 font-medium text-gray-900">Tujuan aduan</label>
                                    <div class="mt-2">
                                        <input type="text" name="first-name" id="first-name" autocomplete="given-name"
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                    </div>
                                ...
                                <div class="col-span-full">
                                    <label for="first-name" class="block text-sm/6 font-medium text-gray-900">Judul laporan</label>
                                    <div class="mt-2">
                                        <input type="text" name="first-name" id="first-name" autocomplete="given-name"
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                    </div>
                                ...
                                <div class="col-span-full">
                                    <label for="about" class="block text-sm/6 font-medium text-gray-900">Keterangan</label>
                                    <div class="mt-2">
                    ...
                    <div class="mt-6 flex items-center justify-end gap-x-6"> 
                        <button type="submit"
                            class="rounded-md w-full bg-indigo-700 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Save</button>
                    </div>
                </form>
